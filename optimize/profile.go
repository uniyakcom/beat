...
// 特点: Emit ~23ns/op，UnsafeEmit ~8.5ns/op，~57ns/op 高并发，error 返回
func Sync() *Profile {
	return &Profile{
		Name:        "sync",
		Conc:        1000,
...
// 特点: ~42ns/op 单线程，~24ns/op 高并发，零 CAS，零分配，Per-P SPSC ring
func Async() *Profile {
	return &Profile{
		Name:        "async",
		Conc:        100000,
...
// 特点: ~153ns/op 单线程，多阶段 Pipeline，信号量唤醒，At-least-once
func Flow() *Profile {
	return &Profile{
		Name:         "flow",
		Conc:         5000,
